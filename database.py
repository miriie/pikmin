...
def add_dummy_reviews():
    ...
    reviews_data = [
        ...
        ("Mario Party Superstars", 3, "can't believe my main shot the united healthcare ceo. smhmh.", "luigi", '2024-12-03', 'images/redpik.png', "rice"),
        ...
        ("Pokémon Violet", 2, "Love the open-world experience with lots of new Pokemon, but it's a bit laggy :/", "Good but Laggy", '2024-12-05', 'images/rockpik.png', "user3"),
